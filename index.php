    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-10 offset-lg-1">
          <ul class="categories">
            <li><a href="category.php"><span class="icon"><img src="images/search-icon-01.png" alt="Home"></span> Apartments</a></li>
            <li><a href="listing.php"><span class="icon"><img src="images/search-icon-02.png" alt="Food"></span> Food &amp; Life</a></li>
